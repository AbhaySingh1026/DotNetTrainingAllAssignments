...
namespace FOOD_COURT_MANAGEMENT_SYSTEM
{
    public class FoodCategory
    {
        public FoodCategory()
        {
            FileStream fileStreamObj = new FileStream(@"E:\KelltonTech\.NET training kellton\Real Training Started\DotNetTrainingAllAssignments\FOOD COURT MANAGEMENT SYSTEM\FoodCategory.txt", FileMode.Open);
        TOP:
            ...
            Console.WriteLine("4. Listing of all food Category");
            ...
            switch (input)
            {
                ...
                case 2:
                    Edit(fileStreamObj);
                    fileStreamObj.Close();
                    File.Delete(@"E:\KelltonTech\.NET training kellton\Real Training Started\DotNetTrainingAllAssignments\FOOD COURT MANAGEMENT SYSTEM\FoodCategory.txt");
                    File.Move(@"E:\KelltonTech\.NET training kellton\Real Training Started\DotNetTrainingAllAssignments\FOOD COURT MANAGEMENT SYSTEM\FoodCategory1.txt", @"E:\KelltonTech\.NET training kellton\Real Training Started\DotNetTrainingAllAssignments\FOOD COURT MANAGEMENT SYSTEM\FoodCategory.txt");
                    break;
                case 3:
        ...
        void Edit(FileStream fileStreamObj)
        {
            ...
            using (FileStream fileStreamObj2 = new FileStream(@"E:\KelltonTech\.NET training kellton\Real Training Started\DotNetTrainingAllAssignments\FOOD COURT MANAGEMENT SYSTEM\FoodCategory1.txt", FileMode.Create, FileAccess.Write))
            {
